...
const AccidentRecords = (props) => {
  ...
  useEffect(() => {
    props.data.find((favoriteX) => favoriteX.id === 42 && setIsFavorite(true));
  }, []);
        ...
        <TopContentContainer>
          ...
          <div style={{ marginTop: '14px' }}>
            <div style={{ textAlign: 'center' }}>
              <Typography variant="h4">Registro de Acidentes</Typography>
            </div>
            <DescriptionText>
              Neste serviço você poderá realizar o registro de um acidente
              através da plataforma web ou aplicação mobile, indicando hora,
              local e envolvidos, buscando facilitar o socorro.
            </DescriptionText>
          </div>
          {isFavorite ? (
            <span>
