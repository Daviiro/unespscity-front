...
const VictimsOfDomesticViolence = (props) => {
  ...
  useEffect(() => {
    props.data.find((favoriteX) => favoriteX.id === 44 && setIsFavorite(true));
  }, []);
      ...
      <ContentContainer>
        <TopContentContainer>
          ...
          <div style={{ marginTop: '14px' }}>
            ...
            <DescriptionText>
              Neste serviço você poderá realizar denúncia de violência doméstica
              através da plataforma web ou aplicação mobile, recebendo mais
              informações sobre como oficializar a denúncia nos meios jurídicos
            </DescriptionText>
          </div>
          {isFavorite ? (
            <span>
