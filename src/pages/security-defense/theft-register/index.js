...
const TheftRegister = (props) => {
  ...
  useEffect(() => {
    props.data.find((favoriteX) => favoriteX.id === 43 && setIsFavorite(true));
  }, []);
        ...
        <TopContentContainer>
          ...
          <div style={{ marginTop: '14px' }}>
            <div style={{ textAlign: 'center' }}>
              <Typography variant="h4">Registro de Roubos e Furtos</Typography>
            </div>
            <DescriptionText>
              Utilize este serviço para informar ocorrências de roubos e furtos
              que aconteceram, assim a policia será informada também.
            </DescriptionText>
          </div>
          {isFavorite ? (
            <span>
