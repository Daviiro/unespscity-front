...
const AdocaoAreasDisponiveis = (props) => {
  ...
  useEffect(() => {
    props.data.find((favoriteX) => favoriteX.id === 53 && setIsFavorite(true));
        ...
        <ContentContainer>
          <TopContentContainer>
            ...
            <div style={{ marginTop: '14px' }}>
              ...
              >
                <DescriptionText>
                  Aqui você pode checar a lista das Áreas Públicas passíveis de
                  adoção que encontram- se disponíveis. Para visualizar as que
                  já encontram-se adotadas, clique AQUI.
                </DescriptionText>
              </Link>
            </div>
            {isFavorite ? (
