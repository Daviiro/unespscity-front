...
const GuardianMonitoring = (props) => {
  ...
  useEffect(() => {
    props.data.find((favoriteX) => favoriteX.id === 51 && setIsFavorite(true));
  }, []);
        ...
        <TopContentContainer>
          ...
          <div style={{ marginTop: '14px' }}>
            <div style={{ textAlign: 'center' }}>
              <Typography variant="h4">Monitoramento do Guardinha</Typography>
            </div>
            <DescriptionText>
              Neste serviço você terá informações sobre a rota de movimentação
              do guardinha que protege e cuida da sua residência.
            </DescriptionText>
          </div>
          {isFavorite ? (
            <span>
