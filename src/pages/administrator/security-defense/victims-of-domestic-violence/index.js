          ...
          <div style={{ marginTop: '14px' }}>
            <div style={{ textAlign: 'center' }}>
              <Typography variant="h4">
                Lista de casos de violência doméstica registrados
              </Typography>
            </div>
            <DescriptionText>
              Aqui você pode conferir as denúncias de casos de violência
              doméstica, podendo então entrar em contato com as autoridades que
              possam resolver o problema em questão.
            </DescriptionText>
          </div>
          <div></div>
        </TopContentContainer>
