    ...
    return (props.trigger) ? (
        <PopupBackground>
            <PopupContainer style = {{ width: "45%" }} >
                <Link to = "/admin/conheca_os_gestores" style={{ textDecoration: "none", color: "#1b262c" }}>
                    <MiniCard
						source="/assets/img/home_conheca_os_gestores.png"
						titulo="Conheça os Gestores"
                    />
                </Link>
                <Link to = "/admin/consultar-propostas-de-leis" style={{ textDecoration: "none", color: "#1b262c" }}>
                    <MiniCard
						source="/assets/img/home_noticias.png"
						titulo="Consultar as propostas dos vereadores"
                    />
                </Link>
                <Link to = "/admin/central-anticorrupcao" style={{ textDecoration: "none", color: "#1b262c" }}>
                    <MiniCard
