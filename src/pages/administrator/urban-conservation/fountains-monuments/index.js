	...
	return (
		<>
			<ContainerBase>
				...
				<Square>
					<ServiceDescription description="Lista com todas as ocorrências de monumentos e chafarizes da cidade com vandalização, solicitação de limpeza, destruição e/ou outras irregularidades." />
					<Details>
						<AdminListCard
