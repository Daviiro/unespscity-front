          ...
          <MiniCard
            ...
            linkItems={[
              ...
              },
              {
                ...
                link: '/admin/consultar_propostas_de_leis',
              },
            ]}
          />
          <div style={{ marginTop: '14px' }}>
            <div style={{ textAlign: 'center' }}>
              <Typography variant="h4">Consultar propostas de leis</Typography>
            </div>
            <DescriptionText>
              Adicione aqui as propostas de leis, e seus detalhes, que serão
              votadas.
            </DescriptionText>
          </div>
          <div></div>
