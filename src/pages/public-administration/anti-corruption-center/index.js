...
const AntiCorruptionCenter = (props) => {
  ...
  useEffect(() => {
    props.data.find((favoriteX) => favoriteX.id === 45 && setIsFavorite(true));
  }, []);
      ...
      <ContentContainer>
        <TopContentContainer>
          ...
          <div style={{ marginTop: '14px' }}>
            ...
            <DescriptionText>
              Neste serviço você poderá realizar a denúncia de possível
              atividade corrupta ou de improbidade administrativa para que os
              órgãos responsáveis investiguem e avaliem.
            </DescriptionText>
          </div>
          {isFavorite ? (
            <span>
