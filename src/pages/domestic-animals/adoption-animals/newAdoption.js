...
const NovasDoacoesAnimais = (props) => {
  ...
  useEffect(() => {
    props.data.find((favoriteX) => favoriteX.id === 19 && setIsFavorite(true));
  }, []);
        ...
        <TopContentContainer>
          ...
          <div style={{ marginTop: '14px' }}>
            <div style={{ textAlign: 'center' }}>
              <Typography variant="h4">Doação de Animais</Typography>
            </div>
            <DescriptionText>
              Utilize este serviço para cadastrar um novo animal que você queira
              doar. Para checar a lista completa de animais disponiveis na
              plataforma, clique
              <Link
