...
const AdoptionAnimals = (props) => {
  ...
  useEffect(() => {
    props.data.find((favoriteX) => favoriteX.id === 18 && setIsFavorite(true));
  }, []);
        ...
        <TopContentContainer>
          ...
          <div style={{ marginTop: '14px' }}>
            <div style={{ textAlign: 'center' }}>
              <Typography variant="h4">Adoção de Animais</Typography>
            </div>
            <DescriptionText>
              Aqui você pode checar a lista de animais disponíveis para a
              adoção.
            </DescriptionText>
          </div>
          {isFavorite ? (
