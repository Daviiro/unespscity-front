...
const AnimaisSinantropicos = (props) => {
  ...
  useEffect(() => {
    props.data.find((favoriteX) => favoriteX.id === 23 && setIsFavorite(true));
  }, []);
        ...
        <TopContentContainer>
          ...
          <div style={{ marginTop: '14px' }}>
            <div style={{ textAlign: 'center' }}>
              <Typography variant="h4">Animais Sinantrópicos</Typography>
            </div>
            <DescriptionText>
              Aqui você poderá informar na aplicação a localização
              (georreferenciamento) de encontro dos animais, a data e hora do
              registro, podendo inserir uma descrição da situação atual, e fotos
              dos animais encontrados. Com esses dados será possível fazer uma
              solicitação para os gestores tomarem as medidas necessárias.
            </DescriptionText>
          </div>
