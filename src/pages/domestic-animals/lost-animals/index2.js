...
const AnimaisPerdidosLista = (props) => {
  ...
  useEffect(() => {
    props.data.find((favoriteX) => favoriteX.id === 22 && setIsFavorite(true));
  }, []);
        ...
        <TopContentContainer>
          ...
          <div style={{ marginTop: '14px' }}>
            <div style={{ textAlign: 'center' }}>
              <Typography variant="h4">Animais Perdidos</Typography>
            </div>
            <DescriptionText>
              Aqui você pode checar a lista de animais perdidos do seu
              município. Para cadastrar uma nova ocorrência, clique{' '}
              <Link
