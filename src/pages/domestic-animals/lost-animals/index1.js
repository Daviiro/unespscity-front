...
const AnimaisPerdidosNovo = (props) => {
  ...
  useEffect(() => {
    props.data.find((favoriteX) => favoriteX.id === 21 && setIsFavorite(true));
  }, []);
      ...
      <ContentContainer>
        <TopContentContainer>
          ...
          <div style={{ marginTop: '14px' }}>
            ...
            <DescriptionText>
              Utilize este serviço para cadastrar um novo animal perdido na
              lista. Para checar a lista completa, clique
              <Link
