...
import { ContainerBase, Details, Form, SubHeader, ContainerColumn, Square, InputAddressContainer } from "./styles";
    ...
    return (
        <>
            <ContainerBase>
                ...
                <Square>
                    <ServiceDescription 
                        description = "Cadastre aqui os endereços em que ocorrem as feiras livres na cidade!"
                    />
                    <Form>
                        <Input 
                            title="Rua / Bairro:"
                    ...
                    <AdminServiceDescription
                        description = "Aqui está a lista de todos as feiras livres cadastradas até o momento."
                    />
                    <Details>
                        <AdminListCard
