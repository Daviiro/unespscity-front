...
const Chart1 = () => {				    // Administração Pública...), maxValue deve receber o número de problemas resolvidos
	...
	return (
        <>		
			...
			<ContainerRow>
				<img src = "/assets/img/home_assossiacao_comercial.png" alt = "Associação Comercial"/>
