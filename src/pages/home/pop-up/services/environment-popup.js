    ...
    return (props.trigger) ? (
        <PopupBackground>
            <PopupContainer style = {{ width: "45%" }} >
                <Link to = "/adocao_areas_opcoes" style={{ textDecoration: "none", color: "#1b262c" }}>
                    <MiniCard
						source="/assets/img/home_pracas.png"
						titulo="Adoção de Áreas Públicas"
                    />
                </Link>
                <Link to = "/monitoramento" style={{ textDecoration: "none", color: "#1b262c" }}>
                    <MiniCard
						source="/assets/img/home_monitoramento_tempo.png"
						titulo="Monitoramento do Tempo"
                    />
                </Link>
                <Link to = "/coleta-de-lixo" style={{ textDecoration: "none", color: "#1b262c" }}>
                    <MiniCard
