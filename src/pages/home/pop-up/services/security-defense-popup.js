    ...
    return (props.trigger) ? (
        <PopupBackground>
            <PopupContainer style = {{ width: "45%" }} >
                <Link to = "/registro-acidentes" style={{ textDecoration: "none", color: "#1b262c" }}>
                    <MiniCard
						source="/assets/img/home_seguranca_defesa_civil.png"
						titulo="Registro de Acidentes"
                    />
                </Link>
                <Link to = "/registro_roubos" style={{ textDecoration: "none", color: "#1b262c" }}>
                    <MiniCard
						source="/assets/img/home_registro_roubos_furtos.png"
						titulo="Registro de Roubos e Furtos"
                    />
                </Link>
                <Link to = "/violencia-domestica" style={{ textDecoration: "none", color: "#1b262c" }}>
                    <MiniCard
