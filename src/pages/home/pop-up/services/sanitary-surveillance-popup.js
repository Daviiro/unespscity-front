    ...
    return (props.trigger) ? (
        <PopupBackground>
            <PopupContainer style = {{ width: "45%" }} >
                <Link to = "/limpeza_de_piscinas" style={{ textDecoration: "none", color: "#1b262c" }}>
                    <MiniCard
						source="/assets/img/home_piscinas.png"
						titulo="Limpeza de Piscinas"
                    />
                </Link>
                <Link to = "/limpeza_de_terreno" style={{ textDecoration: "none", color: "#1b262c" }}>
                    <MiniCard
						source="/assets/img/home_terrenos.png"
						titulo="Limpeza de Terreno"
                    />
                </Link>
                <Link to = "/restaurantes" style={{ textDecoration: "none", color: "#1b262c" }}>
                    <MiniCard
