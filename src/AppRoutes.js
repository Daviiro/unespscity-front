      ...
      <LocalContext.Provider value={[formValues, setFormValues]}>
        ...
        <Routes>
          ...
          <Route element={<AdminRoutes />}>
            ...
            <Route
              exact
              path="/admin/registro_acidentes"
              element={<AdminAccidentRecords />}
            />
            <Route
              exact
              path="/admin/violencia_domestica"
            ...
            <Route
              exact
              path="/admin/familias_carentes_list"
            ...
            <Route
              exact
              path="/admin/coleta_de_lixo"
              element={<AdminRefuseCollection />}
            />
            <Route
              exact
              path="/admin/consultar_propostas_de_leis"
              element={<AdminProposedLegislation />}
            />
            <Route
              exact
              path="/admin/central_anticorrupcao"
              element={<AdminAntiCorruptionCenter />}
            />
            <Route
              exact
              path="/admin/animais_sinantropicos"
              element={<AdminSynanthropicAnimals />}
            />
            <Route
              exact
              path="/admin/comercio_local"
            ...
            <Route
              exact
              path="/admin/monitoramento_guardinha"
              element={<AdminGuardian />}
            />
            <Route
              exact
              path="/admin/monitoramento_pessoas_veiculos"
          ...
          <Route
            exact
            path="/consultar_propostas_de_leis"
            element={
              <ProposedLegislation
                data={favoritesData}
                handleAddFavorite={handleAddFavorite}
          ...
          <Route
            exact
            path="/monitoramento_pessoas_veiculos"
            element={
              <Monitoring
                data={favoritesData}
                handleAddFavorite={handleAddFavorite}
